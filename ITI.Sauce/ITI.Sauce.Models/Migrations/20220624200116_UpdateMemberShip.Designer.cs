...
namespace ITI.Sauce.Models.Migrations
{
    ...
    [Migration("20220624200116_UpdateMemberShip")]
            ...
            modelBuilder.Entity("ITI.Sauce.Models.Recipe", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 1, 15, 867, DateTimeKind.Local).AddTicks(5468));
            ...
            modelBuilder.Entity("ITI.Sauce.Models.Restaurant", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 1, 15, 870, DateTimeKind.Local).AddTicks(1681));
            ...
            modelBuilder.Entity("ITI.Sauce.Models.Users", b =>
                {
                    ...
                    b.Property<DateTime>("registerDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 1, 15, 868, DateTimeKind.Local).AddTicks(6036));
            ...
            modelBuilder.Entity("ITI.Sauce.Models.Vendor", b =>
                {
                    ...
                    b.Property<DateTime>("registerDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 24, 22, 1, 15, 869, DateTimeKind.Local).AddTicks(4919));
