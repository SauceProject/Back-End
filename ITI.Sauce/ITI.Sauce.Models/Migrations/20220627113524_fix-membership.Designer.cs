...
namespace ITI.Sauce.Models.Migrations
{
    ...
    [Migration("20220627113524_fix-membership")]
            ...
            modelBuilder.Entity("ITI.Sauce.Models.Recipe", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 27, 13, 35, 23, 892, DateTimeKind.Local).AddTicks(7466));
            ...
            modelBuilder.Entity("ITI.Sauce.Models.Restaurant", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 27, 13, 35, 23, 898, DateTimeKind.Local).AddTicks(1312));
            ...
            modelBuilder.Entity("ITI.Sauce.Models.Users", b =>
                {
                    ...
                    b.Property<DateTime>("registerDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 27, 13, 35, 23, 894, DateTimeKind.Local).AddTicks(65));
            ...
            modelBuilder.Entity("ITI.Sauce.Models.Vendor", b =>
                {
                    ...
                    b.Property<DateTime>("registerDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 27, 13, 35, 23, 896, DateTimeKind.Local).AddTicks(8505));
